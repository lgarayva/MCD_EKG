...
Interpretar un ECG requiere experiencia clínica y puede variar entre especialistas. Por eso, se ha buscado desarrollar modelos automatizados de interpretación usando machine learning. El dataset PTB-XL, que tiene más de 21,000 registros validados por cardiólogos, permite explorar estas aplicaciones.
...
* No existía un conjunto de datos para entrenamiento y validación público que pudiera utilizarse para entrenar los modelos.
