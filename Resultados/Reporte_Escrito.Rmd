...
En las gráficas se puede observar que con este suavizamiento se elimina variabilidad de las gráficas. Sin embargo, visualmente no se identificaron relaciones claras entre las clases.
...
los tiempos de ejecución que se reportan únicamente como referencia comparativa, ya que algunos modelos se realizaron con una versión reducida de la búsqueda de hiperparámetros por limitaciones computacionales.
