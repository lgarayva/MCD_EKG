...
**Tabla 1** Categorías de súperclases para la clasificación de ECG. 
...
**Tabla 2.** Prueba de Dickey-Fuller para raíces unitarias.
...
**Tabla 3.** Prueba de Dickey-Fuller para raíces unitarias después de aplicar una diferenciación.
...
XGB Classifier
        {
        'learning_rate': [0.1],  # si quisieras probar más, agrega aquí
...
| F1 weighted             |               0.26  |                    0.48  |                        0.50  |        0.28 |           0.52 |
...
| F1 weighted             |               0.26  |                    0.48  |                        0.48  |        0.28 |           0.52 |
...
| F1 weighted             |               0.52  |                    0.53  |                        0.53  |        0.34 |           0.57 |
...
En la Tabla 13 se muestran las métricas de sensibilidad y especifidad por clase para el modelo ganador. La clase OTHER tuvo la mayor sencibilidad (68.2%) y especificidad (89.8%), indicando que el modelo identifica correctamente a los registros normales o con patologías distintas. La clase MI es la que presentó la menor sensibilidad (52.3%) y especifidad (83.7%). Las clases STTC y STTC & MI mostrron sensibilidades (53.6%-55.3%) y especifidades (84.2%-85.4%) similares. Estos resultados sugieren que el modelo logra un desempeño aceptable en la clasificación genera, sin embargo, es necesario optimizar la sensibilidad en las clases de mayor relevancia clínica, como la clase MI, para su aplicación como herramienta de apoyo diagnóstico.
